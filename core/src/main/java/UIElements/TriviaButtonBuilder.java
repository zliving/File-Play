 ...
 * TriviaButtonBuilder will create sets of buttons for each trivia question.
 * Will return an array of buttons for each question. To update the screen
 * you need to call updateTriviaButton after each question is answered.
 */
